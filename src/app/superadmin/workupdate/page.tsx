...
return (
  <div className="max-w-7xl mx-auto px-2 ">
    <h1 className="text-2xl font-bold mb-6 text-center text-gray-800">Daily Reports</h1>
    ...
    {/* Pagination */}
    <div className="flex flex-col md:flex-row justify-between items-center bg-white px-4 py-3 rounded-lg shadow-md gap-4">
